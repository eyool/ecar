...
#define SYSSET_ADDR							SYS_FLASHADDR_START

#define CFGSYS_FLASH_CFG_MD5        CFGSYS_FLASHADDR_START
//#define CFGSYS_FLASH_CFG_N          CFGSYS_FLASH_CFG_MD5+16 /*2字节*/
#define CFGSYS_FLASH_CFG_NP         CFGSYS_FLASH_CFG_MD5+16 /*2字节地址，1字节长度 */
